...
case 3: BufferedReader br1=new BufferedReader(new   InputStreamReader(System.in));
		...
		case 4: while((ch=fis.read())!=-1)
				...
				fos.close();
				break;
case 5: FileReader fr=new FileReader("C:\\Users\\ASUS\\Desktop\\assignments\\fileasg.txt");
